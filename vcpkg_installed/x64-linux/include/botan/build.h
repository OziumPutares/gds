...
* 'configure.py '--distribution-info=vcpkg x64-linux' --disable-cc-tests --with-pkg-config --link-method=copy --with-debug-info --includedir=include --bindir=bin --libdir=lib --without-documentation --with-external-includedir=/home/eugeniusz/Git/Inversity/GDS/GDSBackend/build/vcpkg_installed/x64-linux/include --cpu=x86_64 --cc=gcc --disable-shared --enable-static  --with-external-libdir=/home/eugeniusz/Git/Inversity/GDS/GDSBackend/build/vcpkg_installed/x64-linux/lib'
*
* Target
*  - Compiler: /usr/bin/c++ -fstack-protector -m64 -pthread -std=c++20 -D_REENTRANT -DNDEBUG -fPIC -O3
*  - Arch: x86_64
*  - OS: linux
*/
 ...
 */
#define BOTAN_DISTRIBUTION_INFO "vcpkg x64-linux"
